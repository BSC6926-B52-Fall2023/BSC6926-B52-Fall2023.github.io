...
[R script of workshop 7](workshopScripts/workshop8.R)

[data](https://github.com/BSC6926-B52-Fall2023/workshopScripts/blob/main/data/Calcasieu.csv)
...
## Exercises
For these exercises use the [LDWF Pontchartrain seine sampling dataset](https://github.com/BSC6926-B52-Fall2023/workshopScripts/blob/main/data/Pontchartrain.csv). This dataset is the abundance for each species (in wide format) for 6 sites over 1 date.
