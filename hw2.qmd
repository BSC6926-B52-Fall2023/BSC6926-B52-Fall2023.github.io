...
3.  Short Essay Question: How do the temporal trends of Coastal giant salamander between the sitecode compare (3 pts)?
...
6.  Using ggplot, plot a histogram of the population size after 150 year for each reach with a vertical line of the carrying capacity (1 pts).
